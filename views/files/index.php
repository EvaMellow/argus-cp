...
<?php endif; ?>
	function list() {
		...
		$.get('?do=list&file='+ hashval,function(data) {
			...
			if(data.success) {
				...
				!data.results.length && $tbody.append('<tr><td class="empty" colspan=5>Пусто</td></tr>')
	...
	function renderFileRow(data) {
		...
		var $delete_link = $('<a href="#" />').attr('data-file',data.path).addClass('delete').text('Удалять');
		var perms = [];
